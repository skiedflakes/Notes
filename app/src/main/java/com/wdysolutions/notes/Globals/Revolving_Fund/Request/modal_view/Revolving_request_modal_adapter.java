...
public class Revolving_request_modal_adapter extends RecyclerView.Adapter<Revolving_request_modal_adapter.MyHolder> {

    ArrayList<Revolving_request_modal_model> mdata;
    private Context context;
    private LayoutInflater inflater;

    public Revolving_request_modal_adapter(Context context, ArrayList<Revolving_request_modal_model> data){
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = inflater.inflate(R.layout.revolving_request_modal_row,viewGroup,false);
