...
public class Revolving_request_adapter extends RecyclerView.Adapter<Revolving_request_adapter.MyHolder> {

    ArrayList<Revolving_request_model> mdata;
    private Context context;
    private LayoutInflater inflater;

    public Revolving_request_adapter(Context context, ArrayList<Revolving_request_model> data){
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = inflater.inflate(R.layout.revolving_request_row,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull final MyHolder myHolder, final int position) {
        ...
        final String getBr = mdata.get(position).getBr();
        final String getHid = mdata.get(position).getHid();
        final String getCredit_method = mdata.get(position).getCredit_method();
        final String getDnr_stat = mdata.get(position).getDnr_stat();
        final String getLiquidate_stats_color = mdata.get(position).getLiquidate_stats_color();
        ...
        myHolder.actions.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DialogFragment dialogFragment = new Revolving_request_modal_view();
    ...
    public class MyHolder extends RecyclerView.ViewHolder{
        TextView txt_count, txt_code, txt_created_by,txt_requested_by,txt_cr_method,txt_purpose,txt_amount,txt_date_requested,
        txt_branch,txt_approval,txt_liquidation,txt_replenish,txt_status,txt_approved;
        ImageView actions;
        public MyHolder(View itemView) {
            ...
            txt_cr_method = itemView.findViewById(R.id.txt_cr_method);
