...
import com.wdysolutions.notes.Globals.Petty_Cash.Replenish.modal_view.PettyCash_replenish_modal_adapter;
import com.wdysolutions.notes.Globals.Petty_Cash.Replenish.modal_view.PettyCash_replenish_modal_model;
...
public class Revolving_replenish_adapter extends RecyclerView.Adapter<Revolving_replenish_adapter.MyHolder> {
    ...
    ArrayList<Revolving_replenish_modal_model> mdata;
    private Context context;
    private LayoutInflater inflater;

    public Revolving_replenish_adapter(Context context, ArrayList<Revolving_replenish_modal_model> data){
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = inflater.inflate(R.layout.revolving_replenish_modal_row,viewGroup,false);
