...
public class Check_Voucher_request_main extends Fragment implements Authenticate_DialogFragment.uploadDialogInterface,DatePickerSelectionInterfaceCustom, Check_Voucher_request_adapter.EventListener,Dialog_Action.uploadDialogInterface{
    ...
    public void check_user_account(final int position){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                //module
                hashMap.put("module", "supplier_payments_approval_module");
